...
print_with_delay("Привет бро я хочу сказать что не юзайте этот софт для манипуляции против других людей так как это может плохо для тебя закончиться но ты скорее все ровно меня не послушаешься. Удачи!!!")
